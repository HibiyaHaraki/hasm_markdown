...
| --- | --- | --- | --- | --- | --- | --- |
| **`TC-MD-06-E2E-001`** | `REQ-MD-06-001` `REQ-MD-06-002` `REQ-MD-06-005` `REQ-MD-06-025` | Positive (Collapsed Drawer and Diagnostics Display) | The boot route is loaded with no workspace, and `Open workspace menu` is visible. | Inspect Global Menu Controls | 1. Open Global Menu. 2. Confirm File and Appearance are collapsed. 3. Hover Diagnostics. | 1. File and Appearance controls are collapsed. 2. Diagnostics opens the error and warning list. |
...
| **`TC-MD-06-REACT-009`** | `REQ-MD-06-015` | Positive (Workspace Path and Sync Summary) | A loaded workspace has temporal and target paths. | `src/Menu.jsx` | 1. Open the hamburger menu. 2. Inspect the summary at the top. | 1. Temporal and target paths are shown. 2. Two synchronization status marks are rendered. |
